    ...
    try {
      ...
      if (event) {
        setFormData({
          ...
          quicket_event_id: event.quicket_event_id || '',
      ...
      <div className="mb-8">
        ...
        {id && (
          <div className="mt-2 text-sm text-gray-600">
            <div>Event ID: <span className="font-mono">{id}</span></div>
            <div>
              Staff Scanner Link:{' '}
              <a href={`/staff-scanner?event_id=${id}`} className="text-blue-600 hover:underline">
                {`/staff-scanner?event_id=${id}`}
              </a>
            </div>
          </div>
        )}
          ...
          <div className="mb-6">
            ...
            <div className="mt-1">
              <input
                ...
                className="block w-full pr-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 border-gray-300"
                placeholder="Enter Quicket Event ID to link"
              />
            </div>
            <p className="mt-1 text-xs text-gray-500">Link this event to your Quicket event for scanning.</p>
          </div>
