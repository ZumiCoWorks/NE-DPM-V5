  ...
  return (
    <div className="relative h-screen w-full bg-black flex flex-col">
      ...
      <div className="absolute top-0 left-0 right-0 z-10 bg-gradient-to-b from-black/70 to-transparent p-6">
        <h1 className="text-white text-center text-xl font-semibold">Scan Attendee QR Code</h1>
      ...
      {/* Manual Ticket Entry */}
      <form onSubmit={handleManualSubmit} className="absolute top-24 left-4 right-4 z-20">
        <div className="flex gap-2">
          <Input
            value={ticketInput}
            onChange={(e) => setTicketInput(e.target.value)}
            placeholder="Or type attendee ID"
        ...
        {cameraPermission === 'denied' ? (
          <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-gray-900 to-black">
            <div className="text-center px-6 max-w-md">
              ...
              <h2 className="text-white mb-3 text-lg font-semibold">Camera Access Required</h2>
