...
export const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className="flex h-screen bg-[#09090B] text-white selection:bg-brand-red/30">
      {/* Mobile sidebar */}
      <div
        className={cn(
      ...
      <div className="hidden lg:flex lg:w-72 lg:flex-col lg:fixed lg:inset-y-0 z-40">
        <div className="flex flex-col flex-grow bg-[#111113] border-r border-white/5">
          ...
          <nav className="flex-1 space-y-1 px-4 py-6 overflow-y-auto scrollbar-none">
            {filteredNavigation.map((item) => {
              const isActive = location.pathname === item.href
              return (
                <Link
          ...
          <div className="border-t border-white/5 p-6 bg-[#111113]">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <div className="h-10 w-10 rounded-full bg-[#1C1C1F] flex items-center justify-center border border-white/10">
                  <span className="text-sm font-medium text-white/80 tracking-wider">
