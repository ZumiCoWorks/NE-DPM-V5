// Full Konva-powered FloorplanCanvas copied from NavEazeDPM-main
// Note: depends on `react-konva` and `use-image` packages. Install these in your web app.
...
const FloorplanCanvas = ({
  ...
  const handleMouseDown = (e) => {
    // Start panning if altKey is held or middle mouse
    const evt = e.evt || {};
  ...
  const handleStageClick = (e) => {
    ...
    if (drawingMode === 'poi') {
      // open a POI creation flow: call onNewPoi with name/type optional
    ...
    if (drawingMode === 'segment') {
      ...
      // create segment between start and clickedNode
